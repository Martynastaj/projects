...
@section('content')
    <div class="container-fluid px-4">
        ...
        <h2 class="mb-3 font-weight-bold">Lista Usług Usługodawcy</h2>
                    ...
                    <tr class="table-row">
                        ...
                        <td class="align-middle">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <form action="{{ route('admin.delete_service', $service->id) }}"
                                      method="POST" class="m-0">
                                    @csrf
                                    <button type="submit"
                                            class="btn btn-danger btn-rounded text-white ml-6"
